import { Home as HomeIcon, MapPin, Navigation, AlertTriangle, User, LayoutDashboard, ShieldCheck, Settings, Users, Activity, Bell, Server } from "lucide-react";
            ...
            <NavLink
              ...
              className={({ isActive }) =>
                `flex items-center gap-3 px-4 py-3.5 rounded-xl transition-all ${
                  isActive
                    ? isAdmin ? "bg-slate-100 text-slate-900 font-bold" : "bg-indigo-50 text-indigo-700 font-bold"
          ...
          <NavLink
            ...
            className={({ isActive }) =>
              `flex flex-col items-center justify-center gap-1 p-2 rounded-xl min-w-[70px] transition-all ${
                isActive 
                  ? isAdmin ? "text-slate-900 bg-slate-100" : "text-indigo-700 bg-indigo-50" 
